                    ...
                    <div class="header-top-right collapsed-block text-right  col-md-6 col-sm-8 col-xs-12 compact-hidden">
                        ...
                        <div class="tabBlock" id="TabBlock-1">
                         <div class="form-group currencies-block">
                                ...
                                <?php }else{ ?>
                                <a href="#" onclick="alert('login');window.location = '<?php echo base_url() ?>index.php/User/login'">
                                    <span class="icon icon-credit "></span><i class="fa fa-heart" ></i> My Wish List
                                </a>
                                ...
                                <li class="shopping_cart">
                                    ...
                                    <div id="cart" class=" btn-group btn-shopping-cart">
                                        ...
                                        {
                                         ?>
                                        <a data-loading-text="Loading..." class="top_cart dropdown-toggle" href="<?php echo base_url() ?>index.php/User/shoppingcart">
                                          <?php }else{ ?>
                                           <a data-loading-text="Loading..." class="top_cart dropdown-toggle" href="<?php echo base_url() ?>index.php/User/login">
                                            <?php } ?>
                                            <div class="shopcart">
