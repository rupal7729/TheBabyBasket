		...
		$(document).ready(function()
			{
				...
				$("#btnshoaddchild").click(function()
				{
					$("#myDIVc").slideToggle();

				});

				$("#btncancleaddchild").click(function()
				{
					$("#myDIVc").slideToggle();
...
<div id="wrapper" class="wrapper-full" >
	...
	<div class="main-container container" >
		...
		<div class="row" >
				...
				<!--Right Part Start -->
				<aside class="col-sm-3 hidden-xs" id="column-right" style="border:1px;padding: 20px;background-color: #e6ecf5;">
			...
			<!--Right Part End -->
				...
				<!--Middle Part Start-->
				<div class="col-sm-9"  style="background-color: #ebf4fc;padding-left:50px;padding-bottom: 20px;">
				<h2 class="title">My Profile</h2>
					<br/>
					<div class="col-sm-9" style="border:1px;margin-top: 20px;padding: 20px;background-color: #e6ecf5;">
						<div class="col-sm-6">
							<p style="font-size:20px;"><b><?php echo $adata[0]->firstname; ?> <?php echo $adata[0]->lastname; ?> </b><label style="margin-top: 10px;" id="btnshow"><i class="fa fa-pencil-square-o fa-2x"></i></label></p>
						    <p><?php echo $adata[0]->occupasion; ?></p>
						    <br/>
						    <br/>


						</div>
					<form method="post" action="<?php echo base_url(); ?>index.php/User/update_personal_details" enctype="multipart/form-data">
						<div class="col-sm-6">
							<img src="<?php echo base_url(); ?>upload/<?php echo $adata[0]->profile; ?>" height="170" width="170" border="1" style="margin-left: 90px;">
							<br/>
						...
						<div class="row">
								<input type="file" name="imgnm1" class="custom-file-input" id="myDIVf" style="display:none;margin-left: 73%; ">
						</div>
		      ...
		      <div class="row" >
							...
							<fieldset id="personal-details">
								...
								<div class="form-group required">
									...
									<input type="text" class="form-control" id="input-firstname" placeholder="First Name" value="<?php echo $adata[0]->firstname; ?>" name="firstname">
								</div>
								<div class="form-group required">
									<label for="input-lastname" class="control-label">Last Name</label>
									<input type="text" class="form-control" id="input-lastname" placeholder="Last Name" value="<?php echo $adata[0]->lastname; ?>" name="lastname">
								</div>
								<div class="form-group required">
									<label for="input-email" class="control-label">E-Mail</label>
									<input type="email" class="form-control" id="input-email" placeholder="E-Mail" value="<?php echo $adata[0]->email; ?>" name="email">
								</div>
								<div class="form-group required">
									<label for="input-telephone" class="control-label">Telephone</label>
									<input type="tel" class="form-control" id="input-telephone" placeholder="Telephone" value="<?php echo $adata[0]->mobile; ?>" name="telephone">
								</div>
								<div class="form-group required">
				...
				<div class="col-sm-9" id="content">
						...
						<div class="col-sm-12" style="border:1px;padding: 20px;background-color: #e6ecf5;">
							<div class="col-sm-6">
							    	E-Mail ID :&nbsp;&nbsp;&nbsp; <b> <?php echo $adata[0]->email; ?>   </b>
							    	<br/>
							    	<br/>
							    	Mobile No :&nbsp;&nbsp;&nbsp; <b> <?php echo $adata[0]->mobile; ?>   </b>
							    	<br/>
							    	<br/>
				  	...
				  	<div class="col-sm-9" id="content">
							...
							<div class="col-sm-12" style="margin-top: 10px;padding: 10px; background-color: #e6ecf5;">

								<div class="col-sm-6">
								<?php if(count($check)>=1){ ?>
								     <b> <?php echo $adata[0]->username; ?>   </b>
								      <br/>
								      <b> <?php echo $adata[0]->mobile; ?>   </b>
								      <br/>
								       <?php echo $adata[0]->cityname; ?> -<?php echo $adata[0]->pincode; ?>
								       <br/>
								       <?php echo $adata[0]->statename; ?> ,  <?php echo $adata[0]->country; ?>
								       <br/>

								        <?php echo $adata[0]->houseNo; ?> ,
								       <br/>
								       <?php echo $adata[0]->streetAddress; ?> ,
								       <br/>
								       <?php echo $adata[0]->landmark; ?>

								      <br/>

								      <label id="btnshowupdadd"><i class="fa fa-pencil-square-o fa-2x"></i></label>

								      <?php }else{ ?>
								      <p>You Haven't Add your Address Yet.Update your Address. </p>
								      <?php } ?>
								</div>
					...
					<div class="row">
						...
						<div class="col-sm-9" id="myDIVup" style="display:none;">
							...
							<form method="post" action="<?php echo base_url() ?>index.php/User/update_address">
								...
								<div class="form-group">
									<label for="input-name" class="control-label">Name</label>
									<input type="text" class="form-control" id="input-name" value="<?php echo $adata[0]->username; ?>" name="name">

								</div>
								<div class="form-group required">
									<label for="input-address-1" class="control-label">Flat/House No/Building No</label>
									<input type="text" class="form-control" id="input-address-1" value="<?php echo $adata[0]->houseNo; ?>" name="houseno" required>
								</div>
									<div class="form-group required">
									<label for="input-address-1" class="control-label">Street Address /Colony </label>
									<input type="text" class="form-control" id="input-address-1" value="<?php echo $adata[0]->streetAddress; ?>" name="street" required>
								</div>
								<div class="form-group required">
									<label for="input-landmark" class="control-label">Landmark(optional)</label>
									<input type="text" class="form-control" id="input-landmark" value="<?php echo $adata[0]->landmark; ?>" name="landmark" required>
								</div>
								<div class="form-group required">
									<label for="input-postcode" class="control-label">Post Code</label>
									<input type="text" class="form-control" id="input-postcode" value="<?php echo $adata[0]->pincode; ?>" name="pincode" required>
								</div>
								<div class="form-group required">
									<label for="input-country" class="control-label">Country</label>
									<input type="text" class="form-control" id="input-country" value="<?php echo $adata[0]->country; ?>" name="country">
								</div>
								...
								<div class="form-group required">
									<label for="input-mobile" class="control-label">Mobile</label>
									<input type="text" class="form-control" id="input-mobile"  value="<?php echo $adata[0]->mobile; ?>" name="mobile">
								</div>
				...
				<div class="col-sm-9" id="content">
					  		...
					  		<h2 class="title">My Child Details</h2>
					  		<div class="col-sm-12">
						  		<div class="col-sm-6">

						  			<h4 class="title">My Child Details</h4>

						  		</div>
						  		<div class="col-sm-6">
						  			<label id="btnshoaddchild" class="btn btn-md btn-primary"  style="margin-top:0px;margin-left: 180px;">Add child details</label>
						  		</div>
					  		 </div>
							...
							<div class="col-sm-12" style="margin-top: 20px;padding: 20px;background-color: #e6ecf5;">

								<div class="col-sm-6" >
								     Name :<b> <?php echo $ckey->childName; ?>   </b>
								      <br/>
								      Date Of Birth:<b> <?php echo $ckey->dob; ?>   </b>
									  <br/>
								      Gender:<b> <?php echo $ckey->gender; ?>   </b>
								...
								<div class="col-sm-6">
											<img src="<?php echo base_url(); ?>upload/<?php echo $ckey->photo; ?>" height="100" width="100" border="1" style="margin-left: 20px;">
											 <label id="btneditlbl" style="margin-left:20px;"><a href='<?php echo base_url(); ?>index.php/User/updatechild?childid=<?php echo $ckey->childid; ?>'><i class="fa fa-pencil-square-o fa-2x"></i></a></label>
											 <label id="btdeletelbl" style="margin-left:20px;"><a href="<?php echo base_url(); ?>index.php/User/deletechild?childid=<?php echo $ckey->childid ?>"><i class="fa fa-trash fa-2x" aria-hidden="true"></i></a></label>
								</div>
							...
							<?php } }else{ ?>
								...
								<div class="col-sm-12" style="margin-top: 20px;padding: 20px;background-color: #e6ecf5;">
									<p>Add your Child Details And get Easy filtering..</p>
								</div>
							<?php } ?>
				...
				<div class="row">
							<div class="col-sm-9" id="myDIVc" style="display:none;">
								<fieldset id="address">
								<form method="post" action="<?php echo base_url() ?>index.php/user/addchild" enctype="multipart/form-data">
									...
									<div class="buttons clearfix">
										<div class="pull-right">
											...
											<lable id="btncancleaddchild" class="btn btn-md btn-primary">Cancel</lable>
										</div>
									</div>
									</form>
								</fieldset>
