									...
									<div class="form-group box-info-product">
										...
										<div class="cart">
										 <?php if (isset($_SESSION['user'])) { ?>
											<input type="button" data-toggle="tooltip" title="" value="Add to Cart" data-loading-text="Loading..." id="button-cart" class="btn btn-mega btn-lg" onclick="cart.add('<?php echo $productdetail[0]->productid ?>', document.getElementById('quantity').value,'<?php echo $productdetail[0]->productName ?>','<?php echo base_url() ?>upload/products/<?php echo $productdetail[0]->ImageLogo ?>');" data-original-title="Add to Cart">
												    <?php }else{ ?>
