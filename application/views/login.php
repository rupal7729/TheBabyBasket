						...
						<div class="row">
							...
							<form method="post" id="userlogin">
								<div class="col-sm-6 customer-login">
									<div class="well">
										<h2 align="center"><i class="fa fa-file-text-o" aria-hidden="true"></i> Login</h2>
										<p><strong></strong></p>
									...
									<div class="bottom-form">
										...
										<a href="<?php echo base_url() ?>index.php/User/registration" class="forgot">Sign Up/Register<i class="fa fa-question"></i></a>&nbsp;&nbsp;
