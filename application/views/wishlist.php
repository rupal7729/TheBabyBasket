				...
				<div class="table-responsive">
					<table class="table table-bordered table-hover">
						...
						<tbody>
							...
							<?php if(count($wish)>=1)
							{
								foreach ($wish as $wkey) {
								?>
								<tr>
								<td class="text-center">
									<a  href="product.html"><img width="70px" src="<?php echo base_url() ?>upload/products/<?php echo $wkey->ImageLogo;?>" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop">
									</a>
								</td>
								<td class="text-left"><a href="product.html"><?php echo $wkey->productTitle; ?></a>
								</td>

								<td class="text-right"> <?php if($wkey->stock=="Available"){ ?>In Stock <?php }else{ ?>Few Left<?php } ?></td>
								<td class="text-right">
									<div class="price"> <span class="price-new"><i class="fa fa-rupee"></i><?php echo $wkey->salePrice; ?></span> <span class="price-old"><i class="fa fa-rupee"></i><?php echo $wkey->price; ?></span></div>
								...
								<td class="text-right">
									...
									<a class="btn btn-danger" title="" data-toggle="tooltip" href="<?php echo base_url() ?>index.php/User/removerwishlist?rid=<?php echo $wkey->productid ?>" data-original-title="Remove"><i class="fa fa-times"></i></a>
								</td>
								</tr>
								<tr>
								<?php }}else{ ?>

								<td colspan="5"><p align="center">Your Wishlist is Empty</p></td>
								<?php } ?>
								</tr>
